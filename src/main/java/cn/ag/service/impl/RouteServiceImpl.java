...
public class RouteServiceImpl implements RouteService {
    ...
    public List<Route> findRecommendRoute(int count) {
        ArrayList<Route> route = new ArrayList<>();
        List<Route> route1=   routeDao.findRecommendRoute(count);
        for (Route route2 : route1) {
            Route indexroute = routeDao.findOne(route2.getRid());
            route.add(indexroute);
        }
    ...
    public List<Route> findindexNewRoute(int count) {
        ArrayList<Route> route = new ArrayList<>();
        List<Route> route1=   routeDao.findindexNewRoute(count);
        for (Route route2 : route1) {
            Route indexroute = routeDao.findOne(route2.getRid());
            route.add(indexroute);
        }
    ...
    public List<Route> findindexThemeRoute(int count) {
        ArrayList<Route> route = new ArrayList<>();
        List<Route> route1=   routeDao.findindexThemeRoute(count);
        for (Route route2 : route1) {
            Route indexroute = routeDao.findOne(route2.getRid());
            route.add(indexroute);
        }
